                ...
                IoT Water Level
                     ...
                     {isAuthenticated && (
                       <div className="flex items-center space-x-1">
                         ...
                         <Link
                           href="/notifications"
                           className="px-4 py-2 text-sm font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-all duration-200 relative"
                         >
                           通知
